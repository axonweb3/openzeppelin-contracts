...
:AccessControl: pass:normal[xref:#AccessControl[`++AccessControl++`]]
...
:getRoleMemberCount: pass:normal[xref:#AccessControl-getRoleMemberCount-bytes32-[`++getRoleMemberCount++`]]
:getRoleMember: pass:normal[xref:#AccessControl-getRoleMember-bytes32-uint256-[`++getRoleMember++`]]
...
:RoleAdminChanged: pass:normal[xref:#AccessControl-RoleAdminChanged-bytes32-bytes32-bytes32-[`++RoleAdminChanged++`]]
:RoleGranted: pass:normal[xref:#AccessControl-RoleGranted-bytes32-address-address-[`++RoleGranted++`]]
:RoleRevoked: pass:normal[xref:#AccessControl-RoleRevoked-bytes32-address-address-[`++RoleRevoked++`]]
...
:onlyRole: pass:normal[xref:#TimelockController-onlyRole-bytes32-[`++onlyRole++`]]
...
.Modifiers
--
* {xref-TimelockController-onlyRole-bytes32-}[`++onlyRole(role)++`]
--
